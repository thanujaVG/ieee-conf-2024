    ...
    <section className='committe-page-main-container'>
        ...
        <div className="patrons-container">
            ...
            <div className='left-alignment-style'>
                ...
                {/* <h3 className="committe-details">Mr. Lokesh Rayasandra Boregowda, Samsung, Bengaluru</h3> */}
        ...
        <div className="patrons-container">
            ...
            <div className="patron-card">
                    <h2 className="patron-name">Dr. Abhishek Appaji</h2>
                ...
                <div className="patron-card">
                    {/* need to be edited */}
                    <h2 className="patron-name">Dr. Anandi Giridharan</h2>
                    <h3 className="patron-designation">Chair IEEE SIGHT Execom Member, Bengaluru Section</h3>
